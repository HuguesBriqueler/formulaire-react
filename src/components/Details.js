      ...
      <div className="form">
        ...
        <div class="container">
          ...
          <select id="Typebox">
            ...
            <option value="Alimentation Spécialisée">
            ...
            <option value="Chapellerie Chemiserie">
            ...
            <option value="Epicerie internationale Goodies">
            ...
            <option value="Magasin spécialisé américain">
            ...
            <option value="Numismatique Pièce de monnaie Collection">
